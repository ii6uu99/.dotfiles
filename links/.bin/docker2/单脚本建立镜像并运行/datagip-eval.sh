...
RUN apt-get -y install xterm wget \\
 && wget https://download-cf.jetbrains.com/datagrip/datagrip-2016.2.5.tar.gz \\
 && tar xzvf datagrip-2016.2.5.tar.gz \\
 && rm datagrip-2016.2.5.tar.gz
